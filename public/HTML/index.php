                        ...
                        <div class="item">
                            <div class="content">
                                <a href="">
                                    <h5>Real Estate</h5>
                                    <div class="icon">
                                        <img src="assets/img/icon/realestate.svg" alt="">
                                    </div>
                                    <div class="action">
                        ...
                        <div class="item">
                            <div class="content">
                                <a href="">
                                    <h5>Get Healthy</h5>
                                    <div class="icon">
                                        <img src="assets/img/icon/healthy.svg" alt="">
                                    </div>
                                    <div class="action">
                                        <i class="fa-solid fa-arrow-right"></i>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="whoweare">
                    <div class="content">
                        <a href="">
                            <div class="image">
                                <img src="assets/img/weare.png" alt="">
                            </div>
                            <div class="title">
                                <h3>Who are we?</h3>
                            </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab2" type="button"
                                    role="tab" aria-controls="tab2" aria-selected="true">Travel</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab3" type="button"
                                    role="tab" aria-controls="tab3" aria-selected="true">Real
                                    Estate</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab4" type="button"
                                    role="tab" aria-controls="tab4" aria-selected="true">Beauty</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab5" type="button"
                                    role="tab" aria-controls="tab5" aria-selected="true">Logistics</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab6" type="button"
                                    role="tab" aria-controls="tab6" aria-selected="true">Technology</button>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="item">
                            <div class="content">
                                <div class="details">
                                    ...
                                    <div class="tag">
                                        <span class="warning">Beauty</span>
                                    </div>
                                    <div class="title">
                                        <a href="">
                                            Why Do You Choose Bags In Turkey?
